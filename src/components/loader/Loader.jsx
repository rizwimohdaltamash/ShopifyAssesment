const Loader = () => {
  return (
    <div
      role="status"
      className="fixed inset-0 flex flex-col items-center justify-center bg-gradient-to-br from-green-50 to-green-100 z-50"
    >
      <svg
        aria-hidden="true"
        className="w-16 h-16 animate-spin text-green-300 fill-green-600"
        viewBox="0 0 100 101"
        fill="none"
