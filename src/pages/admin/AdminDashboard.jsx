...
//                 <div className="bg-black py-5 border border-orange-100 rounded-lg">
//                     <div className='text-white hover:text-gray-500 ml-4 cursor-pointer' onClick={()=>navigate('/')} > <FaCircleArrowLeft size={28} /></div>
               
//                     <h1 className=" text-center text-2xl font-bold text-orange-900">Admin Dashboard</h1>
//                 </div>
//             </div>
...
//                     {/* main  */}
//                     <div className=" bg-black text-white py-5 rounded-xl border border-orange-100">
//                         {/* image  */}
...
//                                 <div className=" border bg-black hover:bg-gray-800 px-4 py-3 rounded-xl" >
//                                     <div className="text-orange-900 w-12 h-12 mb-3 inline-block" >
//                                         <svg
...
//                                     </div>
//                                     <h2 className="title-font font-medium text-3xl text-orange-900 fonts1" >{getAllProduct.length}</h2>
//                                     <p className=" text-orange-900  font-bold" >Total Products</p>
//                                 </div>
//                             </Tab>

//                             {/* Total Order  */}
//                             {/* <Tab className="p-4 md:w-1/4 sm:w-1/2 w-full cursor-pointer">
//                                 <div className=" border bg-black hover:bg-gray-700  px-4 py-3 rounded-xl" >
//                                     <div className="text-orange-900 w-12 h-12 mb-3 inline-block" >
//                                         <svg
//                                             xmlns="http://www.w3.org/2000/svg"
//                                             width={50}
...
//                                         </svg>
//                                     </div>
//                                     <h2 className="title-font font-medium text-3xl text-orange-900 fonts1" >{getAllOrder.length}</h2>
//                                     <p className=" text-orange-900  font-bold" >Total Order</p>
//                                 </div>
//                             </Tab> */}
...
//                                     </div>
//                                     <h2 className="title-font font-medium text-3xl text-orange-900 fonts1" >{getAllOrder.length}</h2>
//                                     <p className=" text-orange-900  font-bold" >User Orders</p>
//                                 </div>
//                             </Tab>
...
//                                     </div>
//                                     <h2 className="title-font font-medium text-3xl text-orange-900 fonts1" >{getAllUser.length}</h2>
//                                     <p className=" text-orange-900  font-bold" >Total User</p>
//                                 </div>
//                             </Tab>
//                         </TabList>
