...
//                         className='bg-red-900 hover:bg-red-700 w-full text-white text-center py-2 font-bold rounded-md '
//                     >
//                         Login
//                     </button>
//                 </div>
...
//                     <h2 className='text-white'>Don't Have an account <Link className=' text-red-600 font-bold' to={'/signup'}>Signup</Link></h2>
//                 </div>
